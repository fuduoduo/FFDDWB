//
//  myhomepageTableViewController.m
//  FFDDWB
//
...
#import "myhomepageTableViewController.h"
#import "AFHTTPRequestOperationManager.h"
#import "UIImageView+AFNetworking.h"
#import "globalinfo.h"
#import "BlogTableViewCell.h"

@interface myhomepageTableViewController(){
    ...
    NSArray *statuesuserarray;
    NSArray *statuesusernamearray;
    NSArray *statuesuserphotoarray;
...
@implementation myhomepageTableViewController
...
-(void)homepageRequest{
    ...
    [myhomepage GET:@"https://api.weibo.com/2/statuses/home_timeline.json" parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject){
        [myhomepagearray addObjectsFromArray:[responseObject valueForKey:@"statuses"]];
       NSLog(@"myhomepagearray------------->%@",responseObject);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    statuesuserarray=[myhomepagearray valueForKey:@"user"];
    statuesusernamearray=[statuesuserarray valueForKey:@"name"];
    statuesuserphotoarray=[statuesuserarray valueForKey:@"profile_image_url"];
    cell.nameLabel.text=[statuesusernamearray objectAtIndex:indexPath.row];
    cell.timeLabel.text=[mystatuestimearray objectAtIndex:indexPath.row];
    NSString *myImageUrl=[statuesuserphotoarray objectAtIndex:indexPath.row];
